const i18n = {
  en: {
    ...
    hero_desc: "AirMosaic AI provides standardized tools — data catalog, acquisition pipelines, model analysis methods, and causal inference frameworks — for external AI agents and local research scripts. No data is bundled in the repository. Everything is fetched on demand.",
    ...
    skill_gcam: "Explore BaseX output structure, interpret configuration files, extract prices, quantities, and technology components via parameterized XQuery.",
  ...
  zh: {
    ...
    hero_desc: "AirMosaic AI 为外部 AI Agent 和本地科研脚本提供标准化工具——数据目录、获取管道、模型分析方法和因果推断框架。仓库不含原始数据，所有数据按需获取。",
